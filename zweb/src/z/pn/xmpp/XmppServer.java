...
import z.pn.xmpp.session.SessionManager;
...
public class XmppServer {
    ...
    public void start() {
        try {
            ...
            // String[]{"mina-config.xml","test-config.xml"});
   ...
   /* public Object getBean(String beanName) {
    ...
    /*
     * private void locateServer() throws FileNotFoundException { Context
     * context = new WebAppContext(contexts, homeDir + File.separator + );
     * String baseDir = "F:/Java���/Ӧ�����/Tomcat 6.0/webapps/ROOT";
     * log.debug("base.dir=" + baseDir);
     * 
     * if (serverHomeDir == null) { try { File confDir = new File(baseDir,
     * "conf"); if (confDir.exists()) { serverHomeDir =
     * confDir.getParentFile().getCanonicalPath(); } } catch
     * (FileNotFoundException fe) { // Ignore } catch (IOException ie) { //
     * Ignore } }
     * 
     * if (serverHomeDir == null) {
     * System.err.println("Could not locate home."); throw new
     * FileNotFoundException(); } else { Config.setProperty("server.home.dir",
     * serverHomeDir); log.debug("server.home.dir=" + serverHomeDir); } }
     */
