...
import z.pn.xmpp.UnauthenticatedException;
...
public class AuthManager {
    ...
    public static String getPassword(String username)
        ...
        User user = ((ServiceLocator)SpringUtil.getbean("serviceLocator")).getUserService().getUserByUsername(username);
        if(null==user){
            return "";
        }else {
