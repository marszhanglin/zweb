...
import z.pn.xmpp.auth.AuthToken;
import z.pn.xmpp.net.Connection;
...
public class ClientSession extends Session {
    ...
    /**
     * 返回xml给客户端 告知已经成功创建session
     * 描述 Creates a new session between the server and a client, and returns it.
     * @author Mars zhang
     * @created 2016年2月11日 下午7:01:39
     * @param serverName
     * @param connection
     * @param xpp
     * @return
