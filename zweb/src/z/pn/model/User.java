...
public class User implements Serializable {
     ...
     * 描述
     */
    private static final long serialVersionUID = 7546945837869666856L;
...
/*    @Formula("select COUNT(au.id) from apn_user au")  //统计
    private int count;*/

    @Transient              // 将忽略这些字段和属性 表示该表没有这个字段
    ...
    public boolean equals(Object o) {
        ...
        if (username != null ? !username.equals(obj.username) : obj.username != null) {
            return false;
        }
